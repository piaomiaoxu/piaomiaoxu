...
window.CONFIG = {
  ...
  shop: {
    ...
    cycle: {
      ...
      displayMonthYear: false, // 是否显示年月 tab 切换和是否显示年付购买按钮
      displayDiscount: false, // 是否显示折扣描述信息，前提是保证月付和年付价格不为 0
    },
    flow: {
      primary_plan: 29, // 按量套餐列表中默认高亮显示的套餐 ID，null 为不高亮显示
      feature: {
        max_num: 5, // 卡片中显示的特性数量，超过此数量的特性将被隐藏，需要 hover 查看更多，0 为全部显示
      },
    },
  ...
  invite: {
    ...
    inviteTargetPage: "register", // 邀请码链接跳转的页面，可选值：'quick' | 'register'，'quick' 为免登购买页面， 'register' 为注册页面
  },
  ...
  welcomeCard: {
    ...
    planId: {
      newUser: 6, // 新用户的推荐套餐 ID
      unsubscribedUser: 6, // 从未订阅过的用户推荐套餐 ID
      expiredUser: 6, // 订阅已过期的用户推荐套餐 ID
      trafficEmptyUser: 6, // 流量已用完的用户推荐套餐 ID
      expirySoonUser: 6, // 订阅快到期的用户推荐套餐 ID
      trafficLowUser: 6, // 流量快用完的用户推荐套餐 ID
      subscriptionUser: 6, // 订阅中的正常用户推荐套餐 ID
    },
